...
![](ubuntu_config/windows-terminal-settings.png?raw=true) <!-- .element height="50%" width="50%" -->
![](ubuntu_config/windows-terminal-ubuntu-default.png?raw=true) <!-- .element height="50%" width="50%" -->
